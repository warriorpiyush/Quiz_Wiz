...
import BG2 from '../../Assets/BG3.svg';
  ...
  >
      ...
      <div className="flex flex-col items-center w-full max-w-md p-6 bg-white rounded shadow-md m-20">
        {isLogin ? (
          ...
          <GoogleSignIn text="Sign in with Google" userType="examiner" useDirect={true} />
          ...
          <>
            ...
            <GoogleSignIn text="Sign up with Google" userType="examiner" useDirect={true} />
